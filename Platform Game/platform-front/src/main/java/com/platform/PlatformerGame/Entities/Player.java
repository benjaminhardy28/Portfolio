package com.platform.PlatformerGame.Entities;

import java.awt.Rectangle;
import com.platform.PlatformerGame.Physics.*;
import com.platform.PlatformerGame.utilz.Constants.PlayerConstants;
...
import static com.platform.PlatformerGame.utilz.Constants.PlayerConstants.*;
...
public class Player implements Entity{
    ...
    public void importImage() {
        try {
            img = ImageIO.read(new FileInputStream("src/main/java/com/platform/res/diverSpriteAtlas.png"));
        } catch (IOException e) {
