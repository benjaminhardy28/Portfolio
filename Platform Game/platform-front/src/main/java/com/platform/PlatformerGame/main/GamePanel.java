...
import static com.platform.PlatformerGame.main.Game.GAME_WIDTH;
import static com.platform.PlatformerGame.main.Game.GAME_HEIGHT;
import com.platform.PlatformerGame.inputs.KeyBoardInputs;
...
public class GamePanel extends JPanel{
    ...
    public GamePanel(Game game){
        ...
        ImageIcon imageIcon2 = new ImageIcon("src/main/java/com/platform/res/backButton/back1.png");
        ...
        backbtn.setRolloverIcon(new ImageIcon("src/main/java/com/platform/res/backButton/back2.png"));
        add(backbtn);
