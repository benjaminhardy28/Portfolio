package com.platform.PlatformerGame.main;
...
public class MenuFrame extends JFrame {
    ...
    public MenuFrame(){
       // this.setContentPane(new ImageIcon());
        ...
        ImageIcon imageIcon = new ImageIcon("src/main/java/com/platform/res/PlayButton/play1.png");
        ...
        playBtn.setRolloverIcon(new ImageIcon("src/main/java/com/platform/res/PlayButton/play2.png"));
        playBtn.setOpaque(false);


        settingsBtn = new JButton("Settings");
        ImageIcon imageIcon2 = new ImageIcon("src/main/java/com/platform/res/SettingButton/setting1.png");
        ...
        settingsBtn.setRolloverIcon(new ImageIcon("src/main/java/com/platform/res/SettingButton/setting2.png"));
